...
#this login method is used to check the username and passwords stored in the user_details.txt file and allows the user to login if username and password match
...
def begin():
    #declared globally to ensure that the variable option can ba accessed and manipulated all throughout the code without it needing to be defined again and again
    global option
...
if (granted): #after value of the grant granted value changes to true with the help of the grant function it then runs the codes below which contains the ordering system of our project
    ...
    Order_list = []
    print('========================== Welcome to Simply Dahlicious, I wish you a happy meal ============ ======================== ')
    print("Today's menu:")
    ...
    while True:
    	print('='*50)
    	print(" 1. User order \n 2. Cancel order \n 3. Confirm menu \n 4. Checkout")
    	server = str(input("Please select service:"))
...
#conditional statements for the choices which basically enters what the customer orders, their value and adds them to the order list
        ...
        #computes the total order by adding all the value of the items ordered then terminates the code
    		...
    		print('Please be informed that we are only accepting online or cashless payments to minimize contact due to the pandemic. \nGcash account: 09171758597 \nPaymaya: 09561422953 \nBdo: 1277041142 \nPlease send a screenshot of your proof of payment to Simply Dahlicious facebook page to confirm your order and shipping address.')
    		break
